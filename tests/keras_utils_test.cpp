...
TEST_CASE("divideWeightsAndBias Functionality 2x3")
{
    ...
    float expected[] = {1, 2, 3, 4, 5, 6, 0.5, 0.7, 0.9};
    float dst[9];
...
TEST_CASE("divideWeightsAndBias Functionality 3x2")
{
    ...
    float expected[] = {1, 2, 3, 4, 5, 6, 0.5, 0.7};
    float dst[8];
...
{
    // Test with small sizes
    float origin[] = {1, 2, 3, 4, 5, 6, 0.5, 0.7, 0.9};
...
{
    // Test with small sizes
    float origin[] = {1, 2, 3, 4, 5, 6, 0.5, 0.7};
...
TEST_CASE("Apply Divide and Merge Multiple Times")
{
    ...
    float expected_divide[] = {1, 2, 3, 4, 5, 6, 0.5, 0.7};
    float expected_merge[] = {1, 2, 3, 6, 0.5, 4, 5, 0.7};
